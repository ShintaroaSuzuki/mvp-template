...
export type DeleteUserMutation = { __typename?: 'Mutation', deleteUser: { __typename?: 'User', id: string, name: string } };
...
export type GetUsersByIdQuery = { __typename?: 'Query', usersByID: Array<{ __typename?: 'User', id: string, name: string }> };
